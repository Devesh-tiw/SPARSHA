...
SEEDS: dict[str, tuple[str, str, str, str]] = {
    ...
    "प्रमेह": ("Prameha", "urinary-metabolic disorder group", "diabetes|high blood sugar|polyuria|metabolic disorder", "Diabetes is routed here only as a provisional broad retrieval term; not a one-to-one diagnosis"),
    ...
    "शिरःशूल": ("Shirashula", "headache / head pain", "headache|head pain|pain in head|migraine-like headache", "Headache has many causes; this is a provisional retrieval label, not a migraine diagnosis"),
